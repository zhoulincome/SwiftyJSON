...
SWIFTC_FLAGS =
LINKER_FLAGS =
RESOURCE_DIR = ".build/debug/SwiftyJSONTests.xctest/Contents/Resources"
...
copytestresources:
	...
	cp Tests/Tests.json ${RESOURCE_DIR}

.PHONY: clean build refetch run test copytestresources
